...
export default function Recommendations({ recommendations, onFeedback, onReset }) {
  return (
    <div className={styles.screen}>
      ...
      <p className={styles.sub}>
        Curated for your mood, your hunger, and the rain outside.
      </p>

      <div className={styles.grid}>
        {recommendations.map((rec, i) => (
          <DishCard key={i} rec={rec} index={i} />
        ))}
      </div>
